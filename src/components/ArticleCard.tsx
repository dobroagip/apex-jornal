    ...
    >
      ...
      <div className="flex justify-between items-start gap-4">
        <div className="flex-1 min-w-0">
          <h3 className="text-xl md:text-2xl font-bold uppercase italic leading-[1.1] mb-2 group-hover:text-racing-red transition-colors line-clamp-2 break-words [hyphens:auto]">
            {article.title}
          </h3>
          ...
          <div className="flex items-center gap-4 text-[10px] uppercase tracking-[0.2em] text-gray-500 font-bold">
            ...
            <span className="w-1 h-1 bg-racing-red rounded-full flex-shrink-0" />
            <span className="whitespace-nowrap">{article.date}</span>
          </div>
        </div>
        <div className="p-3 border border-white/10 rounded-full group-hover:bg-racing-red group-hover:border-racing-red transition-all duration-500 flex-shrink-0">
